...
export function LoginRecoverySection({ callbackUrl }: Props) {
  ...
  return (
    <div className="rounded-lg border border-gray-700/80 bg-gray-900/40 px-3 py-3 text-left">
      <p className="text-xs font-medium text-gray-300">Have a wallet backup file?</p>
      <p className="mt-1 text-[10px] leading-relaxed text-gray-500">
        Sign in with Google or email first, then upload your encrypted backup on the import page.
      </p>
      <Link
        href={importUrl}
